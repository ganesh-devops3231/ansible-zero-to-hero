...
For this create a inventory.ini file in any of the folder and to be mentioned the path of inventory file to access the IPs, if there is no inventory file then it by default considers /etc/ansible/hosts and takes the IP addresses from there.
